...
try {
    ...
    WebUI.executeJavaScript("setTimeout(function(){var b=document.createElement('button');b.id='late-action';b.textContent='Continue';document.body.appendChild(b);},3000);", null)
    TestObject lateAction = new TestObject('late-action')
    lateAction.addProperty('xpath', ConditionType.EQUALS, "//*[@id='late-action']")
    WebUI.waitForElementClickable(lateAction, 1)
