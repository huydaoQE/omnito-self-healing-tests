...
try {
    ...
    WebUI.executeJavaScript("setTimeout(function(){var a=document.createElement('button');a.id='late-one';a.textContent='One';document.body.appendChild(a);},1000);setTimeout(function(){var b=document.createElement('button');b.id='late-two';b.textContent='Two';document.body.appendChild(b);},1800);", null)
