...
try {
    ...
    TestObject legacyBanner = new TestObject('legacy-banner')
    legacyBanner.addProperty('xpath', ConditionType.EQUALS, "//button[@data-testid='dismiss-legacy-banner']")
    WebUI.click(legacyBanner)
