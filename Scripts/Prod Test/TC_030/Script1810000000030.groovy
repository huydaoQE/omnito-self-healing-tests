...
try {
    ...
    WebUI.executeJavaScript("var f=document.querySelector('input[type=email]');if(f){var p=f.parentNode;var n=f.nextSibling;var c=f.cloneNode(true);f.remove();setTimeout(function(){p.insertBefore(c,n);},1500);}", null)
